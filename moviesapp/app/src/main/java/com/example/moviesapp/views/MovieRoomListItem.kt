...
class MovieRoomListItem(private val movies: Movies, private val activity: HomeActivity) : Item() {
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        Picasso.get().load(movies.originalUrl).into(viewHolder.imageView_movieImage)
